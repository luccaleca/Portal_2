...
class SumarioVideoChamadaModel {
    public static function getResumoVendasVideoChamada() {
        ...
        $stmt->execute();   //stmt é um objeto do PDOStatement que representa uma consulta ja preparada, so falta executar
